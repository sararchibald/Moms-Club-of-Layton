  ...
  module Pages
    class MenuPresenter
      ...
      def render_menu_items(menu_items)
        content_tag(list_tag, class: 'right hide-on-med-and-down') do
      ...
      def render_menu_item(menu_item, index, menu_items_length)
        content_tag(list_item_tag, class: "#{menu_item_css(menu_item[0], index, menu_items_length)} waves-effect waves-light") do
